...
export type LifecycleHookAsyncLookup<K extends LifecycleHook> =
    K extends 'onRequest'
        ? onRequestAsyncHookHandler
        : K extends 'preParsing'
          ? preParsingAsyncHookHandler
...
export type ApplicationHookLookup<K extends ApplicationHook> =
    K extends 'onRegister'
...
export type ApplicationHookAsyncLookup<K extends ApplicationHook> =
    K extends 'onRegister'
        ? onRegisterHookHandler
        : K extends 'onReady'
...
export type HookLookup<K extends ApplicationHook | LifecycleHook> =
    K extends ApplicationHook
        ? ApplicationHookLookup<K>
        : K extends LifecycleHook
          ? LifecycleHookLookup<K>
          : never;

export type HookAsyncLookup<K extends ApplicationHook | LifecycleHook> =
    K extends ApplicationHook
