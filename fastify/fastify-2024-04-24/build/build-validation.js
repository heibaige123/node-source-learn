...
const factory = AjvStandaloneCompiler({
    ...
    storeFunction(routeOpts, schemaValidationCode) {
        const moduleCode = `// This file is autogenerated by ${__filename.replace(
            __dirname,
            'build',
        )}, do not edit
...
const schema = {
    ...
    properties: {
        ...
        jsonShorthand: {
            type: 'boolean',
            default: defaultInitOptions.jsonShorthand,
        },
        maxParamLength: {
            type: 'integer',
            ...
            keywords: [
                {
                    ...
                    code(keywordCxt) {
                        ...
                        const logicCode = gen.assign(
                            _`${it.parentData}[${it.parentDataProperty}]`,
                            schemaValue,
                        );
                        return logicCode;
                    },
