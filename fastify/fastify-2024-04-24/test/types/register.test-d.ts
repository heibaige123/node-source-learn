...
const testPluginCallback: FastifyPluginCallback = function (
    instance,
    opts,
    done,
) {};
...
const testPluginOpts: FastifyPluginCallback = function (
    instance,
    opts,
    done,
) {};
const testPluginOptsAsync: FastifyPluginAsync = async function (
    instance,
    opts,
) {};
...
type ServerWithHttp2 = FastifyInstance<
    Http2Server,
    Http2ServerRequest,
    Http2ServerResponse
>;
const testPluginWithHttp2: FastifyPluginCallback<TestOptions, Http2Server> =
    function (instance, opts, done) {};
const testPluginWithHttp2Async: FastifyPluginAsync<TestOptions, Http2Server> =
...
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(testPluginOptsAsync),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(testPluginOptsWithType),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(testPluginOptsWithTypeAsync),
);
expectAssignable<ServerWithHttp2>(
...
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(testPluginWithHttp2WithType),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(testPluginWithHttp2WithTypeAsync),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register((instance) => {
        expectAssignable<FastifyInstance>(instance);
    }),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register((instance: ServerWithHttp2) => {
        expectAssignable<ServerWithHttp2>(instance);
    }),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(async (instance) => {
        expectAssignable<FastifyInstance>(instance);
    }),
);
expectAssignable<ServerWithHttp2>(
    serverWithHttp2.register(async (instance: ServerWithHttp2) => {
        expectAssignable<ServerWithHttp2>(instance);
    }),
);
...
expectAssignable<ServerWithTypeProvider>(
...
expectAssignable<ServerWithTypeProvider>(
    serverWithTypeProvider.register((instance) => {
        expectAssignable<FastifyInstance>(instance);
    }),
);
expectAssignable<ServerWithTypeProvider>(
    serverWithTypeProvider.register((instance: ServerWithTypeProvider) => {
        expectAssignable<ServerWithTypeProvider>(instance);
    }),
);
expectAssignable<ServerWithTypeProvider>(
    serverWithTypeProvider.register(async (instance) => {
        expectAssignable<FastifyInstance>(instance);
    }),
);
expectAssignable<ServerWithTypeProvider>(
    serverWithTypeProvider.register(
        async (instance: ServerWithTypeProvider) => {
            expectAssignable<ServerWithTypeProvider>(instance);
        },
    ),
);
...
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginCallback),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginAsync),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginOpts),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginOptsAsync),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginOptsWithType),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(testPluginOptsWithTypeAsync),
);
expectAssignable<ServerWithTypeProviderAndLogger>(
...
expectAssignable<ServerWithTypeProviderAndLogger>(
    serverWithTypeProviderAndLogger.register(
        async (instance: ServerWithTypeProviderAndLogger) => {
            expectAssignable<ServerWithTypeProviderAndLogger>(instance);
        },
    ),
);
