    ...
    test(`${upMethod} can be created`, (t) => {
        ...
        try {
            ...
            fastify.register(function (fastify2, opts, done) {
                fastify2.setValidatorCompiler(function schema({
                    schema,
                    method,
                    url,
                    httpPart,
                ...
                fastify2[loMethod](
                    '/plugin',
                    withInstanceCustomCompiler,
                    (req, reply) => reply.send({hello: 'never here!'}),
                );
            ...
            sget(
                ...
                (err, response, body) => {
                    ...
                    t.match(body, {
                        error: 'Bad Request',
                        message:
                            /body hello must be a `string` type, but the final value was: `44`./,
                        statusCode: 400,
                        code: 'FST_ERR_VALIDATION',
                    });
                },
