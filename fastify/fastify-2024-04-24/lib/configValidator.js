...
const schema11 = {
    ...
    properties: {
        ...
        maxRequestsPerSocket: {type: 'integer', default: 0, nullable: true},
        ...
        disableRequestLogging: {type: 'boolean', default: false},
        jsonShorthand: {type: 'boolean', default: true},
        ...
        useSemicolonDelimiter: {type: 'boolean', default: true},
        versioning: {
            type: 'object',
                    ...
                    if (!(coerced0 !== undefined)) {
                        if (
                            ...
                            validate10.errors = [
                                {
                                    instancePath:
                                        instancePath + '/connectionTimeout',
                                    schemaPath:
                                        '#/properties/connectionTimeout/type',
                                    keyword: 'type',
                                    params: {type: 'integer'},
                        ...
                        if (!(coerced1 !== undefined)) {
                            if (
                                ...
                                validate10.errors = [
                                    {
                                        instancePath:
                                            instancePath + '/keepAliveTimeout',
                                        schemaPath:
                                            '#/properties/keepAliveTimeout/type',
                                        keyword: 'type',
                                        params: {type: 'integer'},
                                        message: 'must be integer',
                                    },
                    ...
                    if (valid0) {
                        if (data.forceCloseConnections !== undefined) {
                            ...
                            if (!valid1) {
                                const err3 = {
                                    instancePath:
                                        instancePath + '/forceCloseConnections',
                                    schemaPath:
                                        '#/properties/forceCloseConnections/oneOf',
                                    keyword: 'oneOf',
                                            ...
                                            validate10.errors = [
                                                {
                                                    instancePath:
                                                        ...
                                                        '/requestTimeout',
                                                    schemaPath:
                                                        '#/properties/requestTimeout/type',
                                                    keyword: 'type',
                                                    params: {type: 'integer'},
                                                    message: 'must be integer',
                                                },
