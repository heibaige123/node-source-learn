...
Object.defineProperties(Request.prototype, {
    ...
    originalUrl: {
        get() {
            ...
            if (!this[kRequestOriginalUrl]) {
                this[kRequestOriginalUrl] =
                    this.raw.originalUrl || this.raw.url;
            }
    ...
    routeOptions: {
        get() {
            ...
            const version = context.server.hasConstraintStrategy('version')
    ...
    getValidationFunction: {
        value: function (httpPartOrSchema) {
            if (typeof httpPartOrSchema === 'string') {
                ...
                return this[kRouteContext][kRequestCacheValidateFns]?.get(
                    httpPartOrSchema,
                );
            }
        },
    ...
    compileValidationSchema: {
        value: function (schema, httpPart = null) {
            ...
            const validatorCompiler =
                ...
                // nor set
                this.server[kSchemaController].setupValidator(
            ...
            this[kRouteContext][kRequestCacheValidateFns].set(
                schema,
                validateFn,
            );
    ...
    validateInput: {
        value: function (input, schema, httpPart) {
            ...
            if (validate == null) {
                if (
                    this[kRouteContext][kRequestCacheValidateFns]?.has(schema)
                ) {
                    validate =
                        this[kRouteContext][kRequestCacheValidateFns].get(
                            schema,
                        );
                } else {
