...
import {
    Options as FJSOptions,
    SerializerFactory,
} from '@fastify/fast-json-stringify-compiler';
...
} from './types/serverFactory';
import {
    FastifyTypeProvider,
    FastifyTypeProviderDefault,
} from './types/type-provider';
import {
    HTTPMethods,
    RawServerBase,
...
declare namespace fastify {
    ...
    type FindMyWayVersion<RawServer extends RawServerBase> =
    ...
    > = {
        ...
        constraints?: {
            [name: string]: ConstraintStrategy<
                FindMyWayVersion<RawServer>,
                unknown
            >;
        };
        schemaController?: {
        ...
        frameworkErrors?: <
            RequestGeneric extends
                RequestGenericInterface = RequestGenericInterface,
            TypeProvider extends
...
declare function fastify<
    Server extends http2.Http2SecureServer,
    Request extends
        RawRequestDefaultExpression<Server> = RawRequestDefaultExpression<Server>,
    Reply extends
        RawReplyDefaultExpression<Server> = RawReplyDefaultExpression<Server>,
    Logger extends FastifyBaseLogger = FastifyBaseLogger,
    TypeProvider extends FastifyTypeProvider = FastifyTypeProviderDefault,
>(
    opts: fastify.FastifyHttp2SecureOptions<Server, Logger>,
...
declare function fastify<
    ...
    TypeProvider extends FastifyTypeProvider = FastifyTypeProviderDefault,
>(
    opts: fastify.FastifyHttp2Options<Server, Logger>,
): FastifyInstance<Server, Request, Reply, Logger, TypeProvider> &
    PromiseLike<FastifyInstance<Server, Request, Reply, Logger, TypeProvider>>;
...
declare function fastify<
    ...
    TypeProvider extends FastifyTypeProvider = FastifyTypeProviderDefault,
>(
    opts: fastify.FastifyHttpsOptions<Server, Logger>,
): FastifyInstance<Server, Request, Reply, Logger, TypeProvider> &
    PromiseLike<FastifyInstance<Server, Request, Reply, Logger, TypeProvider>>;
...
declare function fastify<
    ...
    TypeProvider extends FastifyTypeProvider = FastifyTypeProviderDefault,
>(
    opts?: fastify.FastifyHttpOptions<Server, Logger>,
): FastifyInstance<Server, Request, Reply, Logger, TypeProvider> &
    PromiseLike<FastifyInstance<Server, Request, Reply, Logger, TypeProvider>>;
